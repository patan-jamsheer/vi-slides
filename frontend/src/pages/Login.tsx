    ...
    <div style={s.page}>
      <div style={s.left}>
        <div style={s.brand}>
          ...
          <p style={s.tagline}>AI-powered adaptive classroom platform that tailors teaching based on student questions.</p>
          <div style={s.features}>
            {["Real-time question analysis", "AI auto-responses", "Class mood insights", "Smart session control"].map(f => (
      ...
      <div style={s.right}>
        <div style={s.card}>
          ...
          <p style={s.link}>
            ...
            <Link to="/register" style={{ color: "#4f67ff", fontWeight: 600 }}>Create one</Link>
          </p>
        </div>
      </div>
    </div>
...
const s: Record<string, React.CSSProperties> = {
  ...
  right: {
    ...
    padding: "60px", background: "#f5f6fa",
  },
  card: {
  ...
  input: {
    background: "#f5f6fa", border: "1.5px solid #e4e6ef",
    borderRadius: "8px", padding: "12px 14px",
    color: "#1a1f36", fontSize: "14px", outline: "none",
  },
  btn: {
  ...
  error: {
    ...
    borderRadius: "8px", padding: "12px", color: "#dc2626", fontSize: "13px",
  },
